#include "rsg_v1_n_1_string/sender_3.hpp"
...
void Sender3Node::publish_main_pub()
{
  ...
  // ==========================================================================
  msg.data = "Hello from sender_3 #" + std::to_string(main_pub_count_);
  // USER LOGIC END
...
int main(int argc, char ** argv)
{
  ...
  auto node = std::make_shared<rsg_v1_n_1_string::Sender3Node>();
