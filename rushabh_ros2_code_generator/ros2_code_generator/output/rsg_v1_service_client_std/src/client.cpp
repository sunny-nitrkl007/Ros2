#include "rsg_v1_service_client_std/client.hpp"
...
namespace rsg_v1_service_client_std
{
...
void ClientNode::call_main_client_async()
{
  if (!wait_for_main_client()) {
    RCLCPP_WARN(this->get_logger(), "Service /robot1/health not available.");
    return;
  }
...
int main(int argc, char ** argv)
{
  ...
  auto node = std::make_shared<rsg_v1_service_client_std::ClientNode>();
