#include "rsg_v1_pub_only_msg/sender.hpp"
...
{
  main_pub_ = this->create_publisher<rsg_v1_pub_only_msg::msg::MachineStatus>(
  ...
  main_pub_timer_ = this->create_wall_timer(
    ...
    std::bind(&SenderNode::publish_main_pub, this));
}
...
void SenderNode::publish_main_pub()
{
  auto msg = rsg_v1_pub_only_msg::msg::MachineStatus();
...
int main(int argc, char ** argv)
{
  ...
  auto node = std::make_shared<rsg_v1_pub_only_msg::SenderNode>();
