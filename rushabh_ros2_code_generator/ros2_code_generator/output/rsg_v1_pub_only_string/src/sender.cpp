#include "rsg_v1_pub_only_string/sender.hpp"
...
namespace rsg_v1_pub_only_string
{
...
void SenderNode::publish_main_pub()
{
  ...
  // ==========================================================================
  msg.data = "Hello from sender #" + std::to_string(main_pub_count_);
  // USER LOGIC END
...
int main(int argc, char ** argv)
{
  ...
  auto node = std::make_shared<rsg_v1_pub_only_string::SenderNode>();
