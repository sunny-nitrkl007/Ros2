#include "rsg_v1_n_n_msg/sender_2.hpp"
...
{
  main_pub_ = this->create_publisher<rsg_v1_n_n_msg::msg::MachineStatus>(
...
{
  auto msg = rsg_v1_n_n_msg::msg::MachineStatus();
...
int main(int argc, char ** argv)
{
  ...
  auto node = std::make_shared<rsg_v1_n_n_msg::Sender2Node>();
