#include "rsg_v1_1_1_msg/receiver.hpp"
...
{
  main_sub_ = this->create_subscription<rsg_v1_1_1_msg::msg::MachineStatus>(
...
void ReceiverNode::on_message(
  const rsg_v1_1_1_msg::msg::MachineStatus::SharedPtr msg)
{
  // ==========================================================================
...
int main(int argc, char ** argv)
{
  ...
  auto node = std::make_shared<rsg_v1_1_1_msg::ReceiverNode>();
