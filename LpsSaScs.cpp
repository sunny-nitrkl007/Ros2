...
void LpsSaWeighApp::LpsSaSEAStatus( )
{
    ...
    //temp
    //LpsSaWeighInfoTbl.SEALevel1EssentialsInstalled = true;
...
bool LpsSaWeighApp::LpsSaWeighingScsTx()
{
    ...
    if (nullptr != LpsSaWeighScsTxOut) {
        ...
        if (txOut.DiagState.none()) {
            ...
            AIS_LOG_ERROR("Diagnostics present, suppressing payload availability. DiagState: %d", txOut.DiagState);
            if (txOut.DiagState[ACDDiagPopUp::HYDRAULIC_OIL_TEMP_BAD]) {
                AIS_LOG_ERROR("Diagnostic: HYDRAULIC_OIL_TEMP_BAD");
            }
            if (txOut.DiagState[ACDDiagPopUp::LIFT_HE_FREQ_ABNORMAL] ||
                txOut.DiagState[ACDDiagPopUp::LIFT_HE_VOLTAGE_ABOVE_NORMAL] ||
                txOut.DiagState[ACDDiagPopUp::LIFT_HE_VOLTAGE_BELOW_NORMAL]) {
                AIS_LOG_ERROR("Diagnostic: LIFT_HE_BAD");
            }
            if (txOut.DiagState[ACDDiagPopUp::LIFT_RE_FREQ_ABNORMAL] ||
                txOut.DiagState[ACDDiagPopUp::LIFT_RE_VOLTAGE_ABOVE_NORMAL] ||
                txOut.DiagState[ACDDiagPopUp::LIFT_RE_VOLTAGE_BELOW_NORMAL]) {
                AIS_LOG_ERROR("Diagnostic: LIFT_RE_BAD");
            }
            if (txOut.DiagState[ACDDiagPopUp::TILT_HE_FREQ_ABNORMAL] ||
                txOut.DiagState[ACDDiagPopUp::TILT_HE_VOLTAGE_ABOVE_NORMAL] ||
                txOut.DiagState[ACDDiagPopUp::TILT_HE_VOLTAGE_BELOW_NORMAL]) {
                AIS_LOG_ERROR("Diagnostic: TILT_HE_BAD");
            }
            if (txOut.DiagState[ACDDiagPopUp::TILT_RE_FREQ_ABNORMAL] ||
                txOut.DiagState[ACDDiagPopUp::TILT_RE_VOLTAGE_ABOVE_NORMAL] ||
                txOut.DiagState[ACDDiagPopUp::TILT_RE_VOLTAGE_BELOW_NORMAL]) {
                AIS_LOG_ERROR("Diagnostic: TILT_RE_BAD");
            }
            if (txOut.DiagState[ACDDiagPopUp::MACHINE_MODEL_NOT_SET]) {
            ...
            if (txOut.DiagState[ACDDiagPopUp::PAYLOAD_SYSTEM_OUT_OF_CAL]) {
                AIS_LOG_ERROR("Diagnostic: PAYLOAD_SYSTEM_OUT_OF_CAL");
            }
            if (txOut.DiagState[ACDDiagPopUp::PAYLOAD_SYSTEM_OUT_OF_CAL]) {
                AIS_LOG_ERROR("Diagnostic: PAYLOAD_SYSTEM_OUT_OF_CAL");
            }
            if (txOut.DiagState[ACDDiagPopUp::LIFT_LINK_OUT_OF_CAL]) {
                AIS_LOG_ERROR("Diagnostic: LIFT_LINK_OUT_OF_CAL");
            }
            if (txOut.DiagState[ACDDiagPopUp::TILT_LINK_OUT_OF_CAL]) {
                AIS_LOG_ERROR("Diagnostic: TILT_LINK_OUT_OF_CAL");
            }
            if (txOut.DiagState[ACDDiagPopUp::LIFT_LINK_FREQ_ABNORMAL] ||
                txOut.DiagState[ACDDiagPopUp::LIFT_LINK_VOLTAGE_ABOVE_NORMAL] ||
                txOut.DiagState[ACDDiagPopUp::LIFT_LINK_VOLTAGE_BELOW_NORMAL]) {
                AIS_LOG_ERROR("Diagnostic: LIFT_LINK_BAD");
            }
            if (txOut.DiagState[ACDDiagPopUp::TILT_LINK_FREQ_ABNORMAL] ||
                txOut.DiagState[ACDDiagPopUp::TILT_LINK_VOLTAGE_ABOVE_NORMAL] ||
                txOut.DiagState[ACDDiagPopUp::TILT_LINK_VOLTAGE_BELOW_NORMAL]) {
